...
function SelectedProject({project, onDeleteProject, tasks, onHandleAddTask, onDeleteTask}) {
    ...
    <div className="w-[35rem] mt-16">
      ...
      <Tasks tasks={tasks} onAddTask={onHandleAddTask} onDeleteTask={onDeleteTask}/>
    </div>
  );
}
